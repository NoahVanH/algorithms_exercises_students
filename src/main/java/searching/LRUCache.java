...
public class LRUCache<K, V> {
    ...
    public LRUCache(int capacity) {
        ...
        // Use a LinkedHashMap with access order to achieve LRU behavior
        // The third argument, true, specifies access-order mode
    ...
    public void put(K key, V value) {
        ...
        if (cache.size() > capacity) {
            // If the cache has exceeded its capacity, remove the least recently used entry
